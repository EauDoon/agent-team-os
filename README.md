...
Get-FileHash .\dist\agent-team-0.1.2.zip -Algorithm SHA256
Expand-Archive .\dist\agent-team-0.1.2.zip -DestinationPath .\dist\expanded
Copy-Item .\dist\expanded\agent-team-0.1.2\skill\agent-team-os $env:CODEX_HOME\skills\agent-team-os -Recurse -Force
```
...
sha256sum dist/agent-team-0.1.2.zip
unzip -q dist/agent-team-0.1.2.zip -d dist/expanded
cp -R dist/expanded/agent-team-0.1.2/skill/agent-team-os "$CODEX_HOME/skills/agent-team-os"
```
