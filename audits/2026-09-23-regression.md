# agent-team-os - baseline regression audit (2026-09-23)
...
|---|---|---:|---:|---:|---:|---:|---:|
| unittest | PYTHONPATH=<repo root> (scripts.X imports); 9 test_*.py files in tests/ | 98 | 96 | 2 | 0 | 0 | 0 |
| **total** | | **98** | **96** | **2** | **0** | **0** | |
...
- Default branch is untouched. Branch push: ` agent-team-os ` @ ` imp/portfolio-triage-phase9-2026-09-23 `.
...
Audit clear. 96/98 pass + 2 skips; no failures or errors.
